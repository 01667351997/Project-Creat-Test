...
public class ControlCreateTest {
    ...
    public IOTuLuanImpl ioTuLuan = new IOTuLuanImpl();
    public IOTracNghiemImpl iOTracNghiem =  new IOTracNghiemImpl();
